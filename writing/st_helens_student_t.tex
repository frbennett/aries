...
\midrule
Uztwm    & 31.69 & 0.58 & 31.39 & 0.77 & $-$0.30 & +0.19 \\
Uzfwm    & 50.22 & 2.30 & 64.67 & 11.0 & +14.5 & +8.74 \\
Lztwm    & 75.58 & 3.45 & 79.20 & 6.18 & +3.62 & +2.72 \\
Lzfpm    & 107.2 & 5.76 & 111.4 & 14.0 & +4.20 & +8.28 \\
Lzfsm    & 63.49 & 5.59 & 56.96 & 16.0 & $-$6.53 & +10.4 \\
Adimp    & 0.083 & 0.013 & 0.067 & 0.032 & $-$0.016 & +0.02 \\
Uzk      & 0.887 & 0.005 & 0.886 & 0.022 & $-$0.001 & +0.02 \\
Lzpk     & 0.0222& 0.0009& 0.0226& 0.0011& +0.0004& $+$0.00 \\
Lzsk     & 0.381 & 0.018 & 0.389 & 0.028 & +0.009 & +0.01 \\
Zperc    & 54.05 & 7.19 & 56.86 & 16.1 & +2.81 & +8.88 \\
Rexp     & 3.053 & 0.355 & 3.084 & 0.956 & +0.031 & +0.60 \\
Pctim    & 0.0053& 0.0012& 0.0048& 0.0014& $-$0.001& $+$0.00 \\
Pfree    & 0.339 & 0.019 & 0.346 & 0.025 & +0.007 & +0.01 \\
Side     & 0.0093& 0.0054& 0.0035& 0.0041& $-$0.006 & $-$0.001 \\
\bottomrule
\end{tabular}
\end{table}
...
Student-$t$ likelihood, compared to 0.534 under Gaussian---a modest
increase reflecting the additional perturbation variance at extreme
observations bleeding into the baseline noise estimate.
...
First, posterior standard deviations are \emph{substantially larger}
for storage and percolation parameters under the Student-$t$ likelihood:
Uzfwm (2.30 $\to$ 11.0), Lzfpm (5.76 $\to$ 14.0), Lzfsm (5.59 $\to$
16.0), and Zperc (7.19 $\to$ 16.1).
The mean increase across all 14 parameters is $+$2.85.
This is the honest consequence of down-weighting flood peaks: these
events carry genuine information about storage capacity and percolation
behaviour, and the Student-$t$ likelihood correctly reflects the
increased uncertainty when that information is partially discounted.
Recession rate parameters (Uzk, Lzpk, Lzsk) and impervious-area
fractions (Adimp, Pctim) show negligible changes in standard deviation,
confirming that these are identified from moderate-flow observations
where both likelihoods agree.

Second, the posterior means shift in physically coherent directions.
The upper-zone free water capacity Uzfwm increases by 14.5 units (from
50.2 to 64.7), indicating that when flood peaks are down-weighted, the
model requires substantially more upper-zone storage to reproduce the
observed hydrograph from the remaining moderate-flow observations.
The lower-zone parameters show smaller shifts: Lzfpm increases modestly
(+4.2) while Lzfsm decreases ($-$6.5), reflecting a reallocation within
the lower zone rather than a net transfer between zones.
The recession rate parameters (Uzk, Lzpk, Lzsk) shift by less than
$0.3\sigma$, confirming that these are identified from recession
dynamics where both likelihoods assign similar weight to observations.
...
\midrule
NSE           & 0.871 & 0.875 & 0.853 & 0.845 \\
PBIAS (\%)    & $-$2.85 & +1.78 & +10.45 & +14.59 \\
$R^2$         & 0.872 & 0.875 & 0.856 & 0.846 \\
P-factor (\%) & 95.7  & \textbf{97.6} & 93.8  & \textbf{96.5} \\
R-factor      & 0.233 & 0.340 & 0.278 & 0.400 \\
CRPS (m$^{3}$/s) & 1.27 & 1.27 & 1.58 & 1.58 \\
Noise $\phi$ (trans.) & 0.534 & 0.542 & --- & --- \\
\bottomrule
\end{tabular}
\end{table}
