...
residuals.
Prediction interval calibration improves from 93.8\% to 96.7\% on
...
\midrule
Uztwm    & 31.69 & 0.58 & 31.30 & 0.50 & $-$0.39 & $-$0.08 \\
Uzfwm    & 50.22 & 2.30 & 47.80 & 2.91 & $-$2.42 & +0.61 \\
Lztwm    & 75.58 & 3.45 & 85.41 & 4.84 & +9.83 & +1.39 \\
Lzfpm    & 107.2 & 5.76 & 141.3 & 7.14 & +34.1 & +1.38 \\
Lzfsm    & 63.49 & 5.59 & 76.25 & 6.21 & +12.8 & +0.62 \\
Adimp    & 0.083 & 0.013 & 0.037 & 0.012 & $-$0.046 & $-$0.001 \\
Uzk      & 0.887 & 0.005 & 0.831 & 0.015 & $-$0.056 & +0.010 \\
Lzpk     & 0.0222& 0.0009& 0.0213& 0.0008& $-$0.001& $-$0.000 \\
Lzsk     & 0.381 & 0.018 & 0.343 & 0.015 & $-$0.038 & $-$0.002 \\
Zperc    & 54.05 & 7.19 & 45.77 & 7.72 & $-$8.28 & +0.54 \\
Rexp     & 3.053 & 0.355 & 3.956 & 0.373 & +0.903 & +0.019 \\
Pctim    & 0.0053& 0.0012& 0.0046& 0.0011& $-$0.001& $-$0.000 \\
Pfree    & 0.339 & 0.019 & 0.337 & 0.017 & $-$0.002 & $-$0.001 \\
Side     & 0.0093& 0.0054& 0.108 & 0.024 & +0.099 & +0.019 \\
\bottomrule
\end{tabular}
\end{table}
...
The mean observation noise $\phi$ converges to 0.542 under the
...
The upper-zone depletion rate Uzk decreases from 0.887 to 0.831
($-0.056$), the lower-zone primary free water capacity Lzfpm increases
from 107.2 to 141.3 (+34.1), and the deep-recharge ratio Side moves
from 0.009 to 0.108 (+0.099).
...
+0.32$), with the largest increases in parameters that shift the most
(Lzfpm: $+1.38$, Lzfsm: $+0.62$), reflecting the reduced effective
sample size when flood observations are discounted.

Second, the recession rate parameters shift in a physically coherent
direction: Uzk decreases from 0.887 to 0.831 ($-0.056$) and Lzsk
...
moving from 0.009 to 0.108---under the Gaussian model this parameter
...
modestly from 0.871 to 0.858 under the Student-$t$ model, while
validation NSE is essentially unchanged (0.853 vs.\ 0.850).
...
\midrule
NSE           & 0.871 & 0.858 & 0.853 & 0.850 \\
PBIAS (\%)    & $-$2.85 & $-$2.82 & +10.45 & +9.70 \\
$R^2$         & 0.872 & 0.858 & 0.856 & 0.851 \\
P-factor (\%) & 95.7  & \textbf{97.4} & 93.8  & \textbf{96.7} \\
...
The P-factor increases from 95.7\% to 97.4\% on training data and from
...
(P-factor from 93.8\% to 96.7\% on validation data) while maintaining
